...
_INPUTREADER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='shuffle_buffer_size', full_name='protos.InputReader.shuffle_buffer_size', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='filenames_shuffle_buffer_size', full_name='protos.InputReader.filenames_shuffle_buffer_size', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='queue_capacity', full_name='protos.InputReader.queue_capacity', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='min_after_dequeue', full_name='protos.InputReader.min_after_dequeue', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='num_epochs', full_name='protos.InputReader.num_epochs', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='num_readers', full_name='protos.InputReader.num_readers', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='prefetch_size', full_name='protos.InputReader.prefetch_size', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='num_parallel_map_calls', full_name='protos.InputReader.num_parallel_map_calls', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='load_instance_masks', full_name='protos.InputReader.load_instance_masks', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='mask_type', full_name='protos.InputReader.mask_type', index=11,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='tf_record_input_reader', full_name='protos.InputReader.tf_record_input_reader', index=12,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='external_input_reader', full_name='protos.InputReader.external_input_reader', index=13,
