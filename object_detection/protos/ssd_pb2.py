...
_SSD = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='encode_background_as_zeros', full_name='protos.Ssd.encode_background_as_zeros', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='negative_class_weight', full_name='protos.Ssd.negative_class_weight', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='box_predictor', full_name='protos.Ssd.box_predictor', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='anchor_generator', full_name='protos.Ssd.anchor_generator', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='post_processing', full_name='protos.Ssd.post_processing', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='normalize_loss_by_num_matches', full_name='protos.Ssd.normalize_loss_by_num_matches', index=11,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='normalize_loc_loss_by_codesize', full_name='protos.Ssd.normalize_loc_loss_by_codesize', index=12,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='loss', full_name='protos.Ssd.loss', index=13,
...
_SSDFEATUREEXTRACTOR = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='use_explicit_padding', full_name='protos.SsdFeatureExtractor.use_explicit_padding', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='use_depthwise', full_name='protos.SsdFeatureExtractor.use_depthwise', index=7,
