...
_FASTERRCNN = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='number_of_stages', full_name='protos.FasterRcnn.number_of_stages', index=0,
