...
_EVALCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='min_score_threshold', full_name='protos.EvalConfig.min_score_threshold', index=12,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='max_num_boxes_to_visualize', full_name='protos.EvalConfig.max_num_boxes_to_visualize', index=13,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='skip_scores', full_name='protos.EvalConfig.skip_scores', index=14,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='skip_labels', full_name='protos.EvalConfig.skip_labels', index=15,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='visualize_groundtruth_boxes', full_name='protos.EvalConfig.visualize_groundtruth_boxes', index=16,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='groundtruth_box_visualization_color', full_name='protos.EvalConfig.groundtruth_box_visualization_color', index=17,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='keep_image_id_for_visualization_export', full_name='protos.EvalConfig.keep_image_id_for_visualization_export', index=18,
