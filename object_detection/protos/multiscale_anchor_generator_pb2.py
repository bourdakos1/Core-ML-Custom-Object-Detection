...
_MULTISCALEANCHORGENERATOR = _descriptor.Descriptor(
  ...
  full_name='protos.MultiscaleAnchorGenerator',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='min_level', full_name='protos.MultiscaleAnchorGenerator.min_level', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='max_level', full_name='protos.MultiscaleAnchorGenerator.max_level', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='anchor_scale', full_name='protos.MultiscaleAnchorGenerator.anchor_scale', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='aspect_ratios', full_name='protos.MultiscaleAnchorGenerator.aspect_ratios', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='scales_per_octave', full_name='protos.MultiscaleAnchorGenerator.scales_per_octave', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='normalize_coordinates', full_name='protos.MultiscaleAnchorGenerator.normalize_coordinates', index=5,
...
MultiscaleAnchorGenerator = _reflection.GeneratedProtocolMessageType('MultiscaleAnchorGenerator', (_message.Message,), dict(
  ...
  # @@protoc_insertion_point(class_scope:protos.MultiscaleAnchorGenerator)
  ))
